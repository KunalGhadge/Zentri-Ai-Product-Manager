...
[![Deploy with Vercel](https://vercel.com/button)](<https://vercel.com/new/clone?repository-url=https://github.com/KunalGhadge/Zentri-Ai-Product-Manager&env=BETTER_AUTH_SECRET&env=OPENAI_API_KEY&env=GOOGLE_GENERATIVE_AI_API_KEY&env=ANTHROPIC_API_KEY&envDescription=BETTER_AUTH_SECRET+is+required+(enter+any+secret+value).+At+least+one+LLM+provider+API+key+(OpenAI,+Claude,+or+Google)+is+required,+but+you+can+add+all+of+them.+See+the+link+below+for+details.&envLink=https://github.com/KunalGhadge/Zentri-Ai-Product-Manager/blob/main/.env.example&demo-title=zentri-ai-pm&demo-description=An+Open-Source+AI+PM+Built+With+Next.js+and+the+AI+SDK+by+Vercel.&products=[{"type":"integration","protocol":"storage","productSlug":"neon","integrationSlug":"neon"},{"type":"integration","protocol":"storage","productSlug":"upstash-kv","integrationSlug":"upstash"},{"type":"blob"}]>)

🚀 **[Live Demo](https://zentriai.vercel.app/)** | See the experience in action in the [preview](#preview) below!

#### Demo Chats

- **MCP Tools Demo:** [Chat with Tools](https://zentriai.vercel.app/export/a4820921-8012-496b-8a5d-13757050bafe)
- **Image Generation Demo:** [Chat with Image Generation](https://zentriai.vercel.app/export/452ad745-9efb-49ae-9114-10db15f1b827)
...
**Zentri AI PM** - An open-source AI Product Manager chatbot for founders and teams, designed to transform product strategy.
...
💡 If you have suggestions or need specific features, please create an [issue](https://github.com/KunalGhadge/Zentri-Ai-Product-Manager/issues)!
...
- 💰 **[Become a sponsor](https://github.com/sponsors/KunalGhadge)** to support ongoing development
