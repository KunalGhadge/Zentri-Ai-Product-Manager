    ...
    <section className="relative pt-64 pb-20 overflow-hidden bg-black flex flex-col items-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl flex flex-col items-center gap-12">
        ...
        <p className="text-white/60 font-body font-light text-xl md:text-2xl max-w-3xl leading-relaxed">
          Give your startup the AI product manager it deserves. No salary, no
          overhead. Just pure clarity on what to build next.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-10 mt-6">
          <Link
            href="/sign-in"
            className="liquid-glass-strong rounded-full px-12 py-5 text-white font-bold text-xl hover:scale-105 transition-all shadow-[0_0_80px_rgba(255,255,255,0.1)] flex items-center gap-3"
          >
            Build Your Product Brain <ArrowUpRight className="h-6 w-6" />
          </Link>
          <Link
            href="/sign-in"
            className="bg-white text-black rounded-full px-12 py-5 text-xl font-bold hover:scale-105 transition-all shadow-2xl"
          >
            Start for Free
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-24 border-b border-white/5">
          <div className="flex flex-col gap-8">
            ...
            <p className="text-white/40 font-body text-sm leading-relaxed max-w-xs">
              The AI product manager for founders and indie hackers. Decide
              faster, build better.
            </p>
          ...
          <div className="flex flex-col gap-8">
            <h5 className="text-white font-body font-bold text-sm uppercase tracking-widest">
              Product
            </h5>
