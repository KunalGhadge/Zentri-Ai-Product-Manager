  ...
  const features = [
    {
      ...
      description:
        "Analyze feedback from Slack, GitHub, and users. Zentri tells you exactly what to build next and why.",
    },
    {
      icon: <BarChart3 className="h-6 w-6 text-white" />,
      title: "Feedback Synthesis",
      description:
        "Stop reading 100s of messages. Zentri distills user pain points into clear, actionable evidence.",
    },
    {
      icon: <Palette className="h-6 w-6 text-white" />,
      title: "Automated PRDs",
      description:
        "From decision to documentation in seconds. Zentri generates high-quality PRDs and specs instantly.",
    },
    {
      icon: <Shield className="h-6 w-6 text-white" />,
      title: "Task Readiness",
      description:
        "Ship faster with less friction. Zentri breaks down decisions into ready-to-code tasks for your team.",
    },
  ];
